...
const Github: React.FC<GithubProps> = ({ commits }) => {
	return (
		<div className="flex flex-col flex-1 gap-2 p-2 md:gap-8 md:p-6 md:flex-row browser-gradient rounded-b-md">
			<div className="flex flex-row items-center w-1/5 gap-4 md:gap-0 md:items-start md:flex-col">
				...
				<div className="flex flex-col">
					...
					<p className="text-lg text-left text-gray-500 ">WitchingHr</p>
				</div>
			</div>

			<div className="flex flex-col items-center flex-1 gap-2">
				{/* readme */}
				<div className="flex flex-col w-full gap-1 p-2 border border-gray-600 rounded-md">
					<p className="text-xs text-left text-gray-600">
						WitchingHr/README.md
					</p>
					<h2 className="text-left">Hey! 👋</h2>
					<p className="text-sm text-left">
						Welcome to my portfolio! Click the URLs in the address bar
