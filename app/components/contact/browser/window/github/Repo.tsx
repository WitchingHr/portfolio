...
// Repo
// renders a github repository with link to page
const Repo: React.FC<RepoProps> = ({ title, desc, href }) => {
	return (
		<div className="w-full p-2 border border-gray-600 rounded-md">
			<div className="flex flex-col items-center justify-between h-full gap-2">
				...
				<div className="flex items-center gap-1 mt-auto mr-auto">
					...
					<span className="mr-2 text-xs text-gray-400">TypeScript</span>
					<svg
						height="12"
						width="12"
						viewBox="0 0 100 100"
