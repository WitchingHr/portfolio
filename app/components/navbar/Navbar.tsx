...
const Navbar = () => {
	...
	return (
		<header
			className="fixed items-start top-0 h-[88px] z-50 left-[50%] translate-x-[-50%]
			header-gradient flex flex-row flex-wrap justify-between w-screen text-xl text-white section-container"
		>
